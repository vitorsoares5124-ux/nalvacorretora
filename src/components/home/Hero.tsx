    ...
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden border-b border-[#2A2A2A]">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8 text-center">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/40 bg-[#1A1A1A]/80 px-4 py-1.5 text-xs font-semibold text-[#D4AF37] backdrop-blur-md mb-8 shadow-lg">
          <Sparkles className="h-3.5 w-3.5 text-[#EAD2A8]" />
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="#destaques"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl gold-gradient-btn px-8 py-4 text-sm font-bold uppercase tracking-wider text-[#0A0A0A] shadow-lg shadow-[#D4AF37]/20 active:scale-95"
          >
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-[#333333] bg-[#141414]/80 px-8 py-4 text-sm font-semibold text-[#F5F5F0] backdrop-blur-sm transition-all duration-300 hover:border-[#D4AF37]/60 hover:text-[#EAD2A8]"
          >
